...
export const metadata = {
  ...
  description:
    'Learn everything there is to know about the icpay API and integrate icpay into your product.',
}
...
Use the icpay API to access contacts, conversations, group messages, and more and seamlessly integrate your product into the workflows of dozens of devoted icpay users. {{ className: 'lead' }}
