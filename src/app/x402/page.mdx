export const metadata = {
  title: 'X402 payments',
  description:
    'How ICPay uses X402: building the authorization header with EIP-712, requesting a wallet signature, and settling the payment via the SDK.',
}
...
- Domain:
  - `name`: `extra.name` or `'Token'`
  - `version`: `extra.eip3009Version` or `'1'`
