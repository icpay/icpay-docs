...
- **Settlement:** The SDK sends a settle request with the X402 header; ICPay validates and processes payment, then your app waits until a confirmation terminal status.
...
// Prefer symbol; ledgerCanisterId is optional for X402 (server resolves it)
